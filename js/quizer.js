...
// RU songs
const ru_1970_f_icon = [
	'pop'
];

const RU_1970_F_PACK_1 = 1;

let ru_1970_f = [
		{
			pack : RU_1970_F_PACK_1,
			group : 'Лариса Мондрус',
			song : 'Проснись и пой (Из к/ф «Джентельмены удачи») (1972)'
		},
		{
			pack : RU_1970_F_PACK_1,
			group : 'Лариса Мондрус',
			song : 'Мне б родиться мальчишкой (1972)'
		},
		{
			pack : RU_1970_F_PACK_1,
			group : 'Татьяна Покрасс',
			song : 'Я ночью шла по улице (1974)'
		},
		{
			pack : RU_1970_F_PACK_1,
			group : 'Нина Бродская',
			song : 'БУ-РА-ТИ-НО (1975)'
		},
		{
			pack : RU_1970_F_PACK_1,
			group : 'Нина Бродская',
			song : 'Звенит январская вьюга (Из к/ф «Иван Васильевич меняет профессию») (1973)'
		},
		{
			pack : RU_1970_F_PACK_1,
			group : 'Анна Герман',
			song : 'Гори, гори, моя звезда (1975)'
		},
		{
			pack : RU_1970_F_PACK_1,
			group : 'Анна Герман',
			song : 'А он мне нравится (1977)'
		},
		{
			pack : RU_1970_F_PACK_1,
			group : 'Анна Герман',
		...
		{
			pack : RU_1970_F_PACK_1,
			group : 'Алиса Фрейндлих',
			song : 'Моей душе покоя нет (Из к/ф "Служебный роман") (1977)'
		},
		{
			pack : RU_1970_F_PACK_1,
			group : 'Алла Пугачёва',
			song : 'Волшебник-недоучка (1977)'
		},
		{
			pack : RU_1970_F_PACK_1,
			group : 'Алла Пугачёва',
			song : 'Песенка первоклассника (1979)'
		},
		{
			pack : RU_1970_F_PACK_1,
			group : 'Алла Пугачёва',
